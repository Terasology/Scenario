 ...
 */
@Replicate
public class ScenarioSecondaryTakeBlockComponent implements Component<ScenarioSecondaryTakeBlockComponent> {
    @Override
    public void copyFrom(ScenarioSecondaryTakeBlockComponent other) {
