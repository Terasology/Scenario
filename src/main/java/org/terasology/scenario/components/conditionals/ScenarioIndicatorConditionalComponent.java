 ...
 */
@Replicate
public class ScenarioIndicatorConditionalComponent implements Component<ScenarioIndicatorConditionalComponent> {
    @Override
    public void copyFrom(ScenarioIndicatorConditionalComponent other) {
