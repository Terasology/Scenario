...
/**
 * An event that is called in order to trigger an action entity to act based on the information entity passed with this event allows for the
 * {@link ScenarioRootManagementSystem} to pass along an information entity that contains information about the triggered event
 * <p>
