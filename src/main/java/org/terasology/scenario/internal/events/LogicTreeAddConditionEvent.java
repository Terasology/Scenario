...
/**
 * Event for adding an condition to the logic tree. Sent to the root entity. hubScreen: The hub tool's screen, if this
 * is passed then after adding the event it will update the tree on this hubScreen, if not passed(null) then it will not
...
public class LogicTreeAddConditionEvent implements Event {
    ...
    public LogicTreeAddConditionEvent() {
    }

    public LogicTreeAddConditionEvent(EntityRef hubScreen, EntityRef triggerEntity) {
