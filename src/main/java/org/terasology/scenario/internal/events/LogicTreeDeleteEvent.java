...
/**
 * Event for deleting an entity from the logic tree. Sent to the root entity. deleteEntity: The entity that is requested
 * to be deleted. deleteFromEntity: The entity that the deleteEntity is attached to(trigger if entity is a
 * event/condition/action, scenario if it is a trigger) hubScreen: The hub tool's screen, if this is passed then after
