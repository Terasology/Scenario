 ...
 * deleteFromEntity: The entity that the deleteEntity is attached to. Will probably be able to get rid of this in future
 *                   I just currently don't know how to reference the parent entity given the structure
