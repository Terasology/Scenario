...
/**
 * Event that is called that tells the server to recreate the entity on the server side based on a list of serialized strings generated by
 * the client by the logic editing screen
 * <p>
 * Construction strings are created from an entity by using {@link ConvertEntitySystem} Construction strings are used to create an entity by
