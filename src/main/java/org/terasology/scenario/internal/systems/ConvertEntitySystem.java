...
/**
 * System that recursively takes a logic entity and develops a list of serialised strings that allow for recreation of
 * the entity following the same order of the list(Makes sure that the list always goes down in in depth, not a skip of
 * branches that would result in wanting to satisfy an entity that doesn't yet exist
 */
@RegisterSystem(RegisterMode.CLIENT)
public class ConvertEntitySystem extends BaseComponentSystem {

    /**
     * Most entities will follow a similar method, but to leave the system open for future inclusions with new
     * event/action/conditions it is designed with each specific component(the unique component of a logic prefab). All
     * are based off the component that indicates what type an entity is.
     * <p>
    ...
    public void DefaultSerialize(ConvertScenarioEntityEvent event, EntityRef entity) {
        ...
        for (Map.Entry<String, EntityRef> e :
                entity.getComponent(ScenarioArgumentContainerComponent.class).arguments.entrySet()) {
            ConvertScenarioEntityEvent newEvent =
                    new ConvertScenarioEntityEvent(event.getPrefix() + "{" + e.getKey() + "}");
    ...
    public void onConvertEntityEvent(ConvertScenarioEntityEvent event, EntityRef entity,
                                     ScenarioValueTriggeringRegionComponent component) {
        event.getOutputList().add(event.getPrefix() + PREFAB_MARKER + entity.getParentPrefab().getName());
    }

    @ReceiveEvent
    public void onConvertEntityEvent(ConvertScenarioEntityEvent event, EntityRef entity,
                                     ScenarioSecondarySendChatComponent component) {
    ...
    @ReceiveEvent
    public void onConvertEntityEvent(ConvertScenarioEntityEvent event, EntityRef entity,
                                     ScenarioValueTriggeringBlockComponent component) {
        event.getOutputList().add(event.getPrefix() + PREFAB_MARKER + entity.getParentPrefab().getName());
    }
    ...
    public void onConvertEntityEvent(ConvertScenarioEntityEvent event, EntityRef entity,
        ...
        if (component.regionEntity.getComponent(NetworkComponent.class).getNetworkId() == 0) { //No network component
            // (local/single player, so can't/don't need to use network id)
    ...
    @ReceiveEvent
    public void onConvertEntityEvent(ConvertScenarioEntityEvent event, EntityRef entity,
                                     ScenarioExpressionRegionNameComponent component) {
        DefaultSerialize(event, entity);
    }

    @ReceiveEvent
    public void onConvertEntityEvent(ConvertScenarioEntityEvent event, EntityRef entity,
                                     ScenarioSecondaryPlayerRegionComponent component) {
        DefaultSerialize(event, entity);
    }

    @ReceiveEvent
    public void onConvertEntityEvent(ConvertScenarioEntityEvent event, EntityRef entity,
                                     ScenarioSecondarySpawnComponent component) {
        event.getOutputList().add(event.getPrefix() + PREFAB_MARKER + entity.getParentPrefab().getName());
    }

    @ReceiveEvent
    public void onConvertEntityEvent(ConvertScenarioEntityEvent event, EntityRef entity,
                                     ScenarioSecondaryRespawnComponent component) {
        event.getOutputList().add(event.getPrefix() + PREFAB_MARKER + entity.getParentPrefab().getName());
    }

    @ReceiveEvent
    public void onConvertEntityEvent(ConvertScenarioEntityEvent event, EntityRef entity,
                                     ScenarioSecondaryLeaveRegionComponent component) {
        DefaultSerialize(event, entity);
    }

    @ReceiveEvent
    public void onConvertEntityEvent(ConvertScenarioEntityEvent event, EntityRef entity,
                                     ScenarioSecondaryEnterRegionComponent component) {
        DefaultSerialize(event, entity);
    }

    @ReceiveEvent
    public void onConvertEntityEvent(ConvertScenarioEntityEvent event, EntityRef entity,
                                     ScenarioSecondaryBlockDestroyComponent component) {
        event.getOutputList().add(event.getPrefix() + PREFAB_MARKER + entity.getParentPrefab().getName());
    }

    @ReceiveEvent
    public void onConvertEntityEvent(ConvertScenarioEntityEvent event, EntityRef entity,
                                     ScenarioSecondaryLogInfoComponent component) {
        DefaultSerialize(event, entity);
    }
    ...
    @ReceiveEvent
    public void onConvertEntityEvent(ConvertScenarioEntityEvent event, EntityRef entity,
                                     ScenarioSecondaryIntCompareComponent component) {
        DefaultSerialize(event, entity);
    }

    @ReceiveEvent
    public void onConvertEntityEvent(ConvertScenarioEntityEvent event, EntityRef entity,
                                     ScenarioSecondaryGiveItemComponent component) {
        DefaultSerialize(event, entity);
    }

    @ReceiveEvent
    public void onConvertEntityEvent(ConvertScenarioEntityEvent event, EntityRef entity,
                                     ScenarioSecondaryGiveBlockComponent component) {
        DefaultSerialize(event, entity);
    }
    ...
    @ReceiveEvent
    public void onConvertEntityEvent(ConvertScenarioEntityEvent event, EntityRef entity,
                                     ScenarioSecondaryTeleportComponent component) {
        DefaultSerialize(event, entity);
    }

    @ReceiveEvent
    public void onConvertEntityEvent(ConvertScenarioEntityEvent event, EntityRef entity,
                                     ScenarioSecondaryBlockCompareComponent component) {
        DefaultSerialize(event, entity);
    }

    @ReceiveEvent
    public void onConvertEntityEvent(ConvertScenarioEntityEvent event, EntityRef entity,
                                     ScenarioSecondaryTakeItemComponent component) {
        DefaultSerialize(event, entity);
    }

    @ReceiveEvent
    public void onConvertEntityEvent(ConvertScenarioEntityEvent event, EntityRef entity,
                                     ScenarioSecondaryTakeBlockComponent component) {
        DefaultSerialize(event, entity);
    }

    @ReceiveEvent
    public void onConvertEntityEvent(ConvertScenarioEntityEvent event, EntityRef entity,
                                     ScenarioSecondaryHealAmountComponent component) {
        DefaultSerialize(event, entity);
    }

    @ReceiveEvent
    public void onConvertEntityEvent(ConvertScenarioEntityEvent event, EntityRef entity,
                                     ScenarioSecondaryDamageAmountComponent component) {
        DefaultSerialize(event, entity);
    }
