...
/**
 * System that takes a list of strings generated by the ConvertEntitySystem in order to create an entity based on the
 * strings
 */
...
public class ConvertIntoEntitySystem extends BaseComponentSystem {
    ...
    @ReceiveEvent
    public void onConvertIntoEntityEvent(ConvertIntoEntityEvent event, EntityRef entity,
        ...
        for (String s : constructions) {
            ...
            // lastKey is the key from the previous entity to the current entity and lastIndex is the index in the
            // string
            ...
            if (matcherLast.group(1).equals(PREFAB_MARKER)) {
                ...
                //Type doesn't actually matter because the entity will be set up to a constant value at the end and
                // therefore
