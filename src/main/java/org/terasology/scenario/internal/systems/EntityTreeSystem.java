...
public class EntityTreeSystem extends BaseComponentSystem {
     ...
     */
    @ReceiveEvent
    public void onLogicTreeAddEventEvent(LogicTreeAddEventEvent event, EntityRef entity,
        ...
        EntityRef newEventEntity = entityManager.create(assetManager.getAsset("scenario:onPlayerSpawnEvent",
                Prefab.class).get());
     ...
     */
    @ReceiveEvent
    public void onLogicTreeAddActionEvent(LogicTreeAddActionEvent event, EntityRef entity,
                                          ScenarioHubToolUpdateComponent component) {
        ...
        EntityRef newActionEntity = entityManager.create(assetManager.getAsset("scenario:givePlayerBlockAction",
                Prefab.class).get());
     ...
     */
    @ReceiveEvent
    public void onLogicTreeAddConditionEvent(LogicTreeAddConditionEvent event, EntityRef entity,
                                             ScenarioHubToolUpdateComponent component) {
        TriggerConditionListComponent conditions =
                event.getTriggerEntity().getComponent(TriggerConditionListComponent.class);
        //Sets up basic action as a give block component
        EntityRef newCondEntity = entityManager.create(assetManager.getAsset("scenario:blockConditional",
                Prefab.class).get());
     ...
     */
    @ReceiveEvent
    public void onLogicTreeAddTriggerEvent(LogicTreeAddTriggerEvent event, EntityRef entity,
                                           ScenarioHubToolUpdateComponent component) {
        ...
        temp.entityForEvent =
                entityManager.create(assetManager.getAsset("scenario:emptyNetworkEntity", Prefab.class).get());
        temp.entityForCondition = entityManager.create(assetManager.getAsset("scenario:emptyNetworkEntity",
                Prefab.class).get());
        temp.entityForAction = entityManager.create(assetManager.getAsset("scenario:emptyNetworkEntity",
                Prefab.class).get());
     ...
     */
    @ReceiveEvent
    public void onLogicTreeDeleteEvent(LogicTreeDeleteEvent event, EntityRef entity,
                                       ScenarioHubToolUpdateComponent component) {
        if (event.getDeleteFromEntity().hasComponent(TriggerNameComponent.class)) { //Must be event/cond/action
            if (event.getDeleteEntity().hasComponent(ScenarioIndicatorEventComponent.class)) { //Event
                TriggerEventListComponent events =
                        event.getDeleteFromEntity().getComponent(TriggerEventListComponent.class);
                ...
                TriggerConditionListComponent conds =
                        event.getDeleteFromEntity().getComponent(TriggerConditionListComponent.class);
                ...
                TriggerActionListComponent actions =
                        event.getDeleteFromEntity().getComponent(TriggerActionListComponent.class);
     ...
     */
    @ReceiveEvent
    public void onLogicTreeMoveEntityEvent(LogicTreeMoveEntityEvent event, EntityRef entity,
                                           ScenarioHubToolUpdateComponent component) {
        List<EntityRef> list;
     ...
     */
    @ReceiveEvent
    public void onReplaceEntityWithPrefabEvent(ReplaceEntityFromConstructionStringsEvent event, EntityRef entity,
                                               ScenarioHubToolUpdateComponent component) {
