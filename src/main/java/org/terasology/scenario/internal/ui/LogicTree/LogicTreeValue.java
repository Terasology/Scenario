...
/**
 * Value for the logic tree, currently it entails the text to display, the image attached, if it is an event or root
 * (Used to denote which buttons/context options are available), and the entity that is attached to the value allowing
 * for easy reference with out traversing the entity tree structure
 */
public class LogicTreeValue {
    ...
    //Constructor if creating an event, action, or conditional and text should be built upon what the actual 
    // action/event is
