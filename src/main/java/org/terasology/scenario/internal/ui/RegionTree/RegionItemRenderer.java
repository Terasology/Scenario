...
/**
 * New item renderer required because it must pull all of the data from components that the normal render would not know
 * about in order to generate the name for the region and the coloring
 */
