...
/**
 * Viewing conditions are modeled after sRGB's "typical" viewing environment with 200 cd/m2. Consecutive colors have a
 * delta E distance of at least 1. Delta E distance is defined in CAM02-UCS as published in "Uniform Colour Spaces Based
 * on CIECAM02 Colour Appearance Model" (Luo et al.)
 */
public final class CieCamColorsScenario {

    /**
     * Luminance (in CIE-Lch) is 65 for all color tones, Chroma is at 65. The entire hue circle is sampled
     * (non-linearly). The color plane is transformed with some clipping (mostly blue and red) into RGB.
     */
